...
import com.springjms.activemq.messaging.MessageReceiver;
...
public class MessagingConfiguration {
	...
	public ConnectionFactory connectionFactory(){
		...
		connectionFactory.setTrustedPackages(Arrays.asList("com.springjms.activemq"));
	...
	public JmsTemplate jmsTemplate(){
		...
		//template.setPubSubDomain(true);//JMS topic template
